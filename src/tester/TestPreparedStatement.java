...
public class TestPreparedStatement {
	...
	public static void main(String[] args) {
		...
		try(Scanner sc=new Scanner(System.in);
				...
				//create PST to hold parameterized query ,whcih represents pre-parsed n pre-compiled sql in the object form
				...
				)
		{
			...
			{
				while(rst.next())
					System.out.printf("Emp Id %d Name %s Salary %.1f Joined on %s %n",rst.getInt(1),
